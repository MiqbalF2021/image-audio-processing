...
function ImageCompressor({ onCompressedImage, }) {
  ...
  return (
    <div>
      ...
      <button className='bg-yellow-400 text-white font-medium py-2 px-4 rounded-lg hover:bg-yellow-500 transition duration-300 mt-5 ' onClick={handleCompress} disabled={!selectedFile}>
        Compress
      </button>
    </div>
  );
